...
public class SistemaMercadoGlobal : MonoBehaviour
{
    ...
    public void InicializarItensPadrao()
    {
        ...
        itens.Add(new DadosItemMercado { id = "energia", nome = "Energia", recurso = RecursoMercado.Nenhum, precoBase = 65, precoAtual = 65, estoqueGlobal = 45000, oferta = 65f, demanda = 50f, volatilidade = 0.05f });
    ...
    private void ProcessarComprasDaIA()
    {
        ...
        foreach (DadosPaisGoverno pais in governo.Paises)
        {
            ...
            if (pais.petroleo < 220) necessidade = ObterItem("petroleo");
            else if (pais.comida < 260) necessidade = ObterItem("comida");
