...
namespace Hegemonia.AI.IA01
{
    ...
    /// </summary>
    public sealed class IA01PlanningAdvisor
    {
        ...
        public IA01PlanningAdvisor(IA01RuntimeContext context, IA01WorldState world, bool enabled)
        {
        ...
        public bool Refresh(float now, DadosPaisGoverno country, bool emergencyReserve)
        {
            ...
            if (context != null)
            {
                context.SetMetric("ia01.planning.priority", priority);
                context.SetMetric("ia01.planning.threatened", threatened ? 1d : 0d);
                context.SetMetric("ia01.planning.food_critical", foodCritical ? 1d : 0d);
                context.SetMetric("ia01.planning.energy_critical", energyCritical ? 1d : 0d);
                context.SetMetric("ia01.planning.housing_critical", housingCritical ? 1d : 0d);
                context.SetMetric("ia01.planning.has_airfield", hasAirfield ? 1d : 0d);
                context.SetMetric("ia01.planning.has_shipyard", hasShipyard ? 1d : 0d);
            }
            ...
            if (changed)
            {
                Debug.Log("[IA01 Planning] " + Status + " | " + Guardrail);
            }
            return changed;
        }
