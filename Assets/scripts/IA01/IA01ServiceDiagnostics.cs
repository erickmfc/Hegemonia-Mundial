...
{
    [Serializable]
    public sealed class IA01ServiceDiagnosticsSnapshot
    {
    ...
    public sealed class IA01ServiceDiagnostics
    {
        private readonly IA01ServiceDiagnosticsSnapshot snapshot = new IA01ServiceDiagnosticsSnapshot();

        public IA01ServiceDiagnosticsSnapshot Snapshot
        {
            get { return snapshot; }
        }
