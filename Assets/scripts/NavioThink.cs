...
/// <summary>
/// Configuração automática do Navio Think.
...
///   - ControleNavioRealista (movimento realista)
...
/// </summary>
public class NavioThink : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log($"[NavioThink] {identidade?.nomeDoNavio} pronto. RB: kinematic, NavAgent: updateRot=false");
    }
}
