...
{
    [Serializable]
    public sealed class IA02NationProfileSnapshot
    {
        public string profileKey = string.Empty;
        public IA02NationPersonality personality = IA02NationPersonality.Balanced;
        public IA02NationDoctrine doctrine = IA02NationDoctrine.Balanced;
        public IA02ExecutionMode defaultExecutionMode = IA02ExecutionMode.Full;
        public IA02NationMode defaultNationMode = IA02NationMode.Normal;
        public IA02NationStage defaultStage = IA02NationStage.Initialization;
        public IA02NationPosture defaultPosture = IA02NationPosture.Development;
    ...
    [Serializable]
    public sealed class IA02ConstructionPhaseLimit
    {
        public IA02NationStage stage = IA02NationStage.Initialization;
    ...
    [Serializable]
    public sealed class IA02ConstructionGovernorSettings
    {
        ...
        [SerializeField] private List<IA02ConstructionPhaseLimit> phaseLimits = new List<IA02ConstructionPhaseLimit>
        {
            new IA02ConstructionPhaseLimit
            {
                stage = IA02NationStage.Initialization,
            ...
            new IA02ConstructionPhaseLimit
            {
                stage = IA02NationStage.Stabilization,
            ...
            new IA02ConstructionPhaseLimit
            {
                stage = IA02NationStage.UrbanDevelopment,
                ...
                // A IA02 tem três âncoras específicas para eles e nunca deve
        ...
        public IReadOnlyList<IA02ConstructionPhaseLimit> PhaseLimits => phaseLimits;

        public IA02ConstructionPhaseLimit ResolvePhaseLimit(IA02NationStage stage)
        {
            IA02ConstructionPhaseLimit best = null;
            if (phaseLimits == null)
            {
                return null;
            }
            ...
            {
                IA02ConstructionPhaseLimit candidate = phaseLimits[i];
                if (candidate == null)
                {
                    continue;
                }
        ...
        public void ApplySnapshot(IA02NationProfileSnapshot snapshot)
        {
            if (snapshot == null)
            {
                return;
    ...
    [CreateAssetMenu(fileName = "IA02NationProfile", menuName = "Hegemonia/IA02/Nation Profile")]
    public sealed class IA02NationProfile : ScriptableObject
    {
        ...
        [SerializeField] private IA02NationPersonality personality = IA02NationPersonality.Balanced;
        [SerializeField] private IA02NationDoctrine doctrine = IA02NationDoctrine.Balanced;
        [SerializeField] private IA02ExecutionMode defaultExecutionMode = IA02ExecutionMode.Full;
        [SerializeField] private IA02NationMode defaultNationMode = IA02NationMode.Normal;
        [SerializeField] private IA02NationStage defaultStage = IA02NationStage.Initialization;
        [SerializeField] private IA02NationPosture defaultPosture = IA02NationPosture.Development;
        ...
        [SerializeField] private IA02ConstructionGovernorSettings constructionGovernor = new IA02ConstructionGovernorSettings();

        [NonSerialized] private IA02NationIdentity runtimeIdentity;
        ...
        public IA02NationPersonality Personality => personality;
        public IA02NationDoctrine Doctrine => doctrine;
        public IA02ExecutionMode DefaultExecutionMode => defaultExecutionMode;
        public IA02NationMode DefaultNationMode => defaultNationMode;
        public IA02NationStage DefaultStage => defaultStage;
        public IA02NationPosture DefaultPosture => defaultPosture;
        ...
        public IA02ConstructionGovernorSettings ConstructionGovernor => constructionGovernor;
        public bool IsRuntimeBound => runtimeIdentity != null;

        public IA02NationIdentity RuntimeIdentity
        {
            get
            {
        ...
        private void OnValidate()
        {
            ...
            {
                constructionGovernor = new IA02ConstructionGovernorSettings();
            }

            constructionGovernor.ApplySnapshot(CaptureSnapshot());
        }

        public IA02NationProfileSnapshot CaptureSnapshot()
        {
            return new IA02NationProfileSnapshot
            {
        ...
        public IA02NationIdentity BuildIdentity(int instanceId, int nationId, int teamId, int matchSeed, IA02ExecutionMode? executionMode = null, IA02NationMode? nationMode = null, IA02NationStage? stage = null, IA02NationPosture? posture = null, string nationNameOverride = null, string presidentNameOverride = null, string currencyNameOverride = null, string currencySymbolOverride = null, string countryProfileOverride = null, string difficultyProfileOverride = null)
        {
        ...
        public IA02NationProfile CloneForRuntime(IA02NationIdentity identity)
        {
            IA02NationProfile clone = Instantiate(this);
        ...
        public void BindRuntimeIdentity(IA02NationIdentity identity)
        {
        ...
        public void ApplyGovernmentBias(DadosPaisGoverno country, string difficultyCode = null)
        {
            ...
            switch (country.perfilIA)
            {
                case PerfilPaisIA.Militarista:
                    personality = IA02NationPersonality.Militaristic;
                    doctrine = IA02NationDoctrine.Defensive;
                ...
                case PerfilPaisIA.ProdutorPetroleo:
                    personality = IA02NationPersonality.SelfSufficient;
                    doctrine = IA02NationDoctrine.Industrial;
                ...
                case PerfilPaisIA.Industrial:
                    personality = IA02NationPersonality.Commercial;
                    doctrine = IA02NationDoctrine.Industrial;
                ...
                case PerfilPaisIA.Aliado:
                    personality = IA02NationPersonality.Diplomatic;
                    doctrine = IA02NationDoctrine.Economic;
                    diplomacyWeight = 0.88f;
                    commercialWeight = 0.70f;
                    cautionWeight = 0.66f;
                    break;
                case PerfilPaisIA.Rival:
                    personality = IA02NationPersonality.Opportunistic;
                    doctrine = IA02NationDoctrine.Defensive;
                ...
                case PerfilPaisIA.Pequeno:
                    personality = IA02NationPersonality.Cautious;
                    doctrine = IA02NationDoctrine.Economic;
                    cautionWeight = 0.82f;
                    economyWeight = 0.72f;
                    ...
                    break;
                default:
                    personality = IA02NationPersonality.Balanced;
                    doctrine = IA02NationDoctrine.Balanced;
                    break;
            }
            ...
            switch (country.modoInicialIA)
            {
                case ModoInicialPaisIA.Paz:
                    defaultExecutionMode = IA02ExecutionMode.Manual;
                    defaultNationMode = IA02NationMode.Peace;
                    defaultStage = IA02NationStage.Initialization;
                    defaultPosture = IA02NationPosture.Peace;
                    break;
                case ModoInicialPaisIA.Comercial:
                    defaultExecutionMode = IA02ExecutionMode.Hybrid;
                    defaultNationMode = IA02NationMode.Normal;
                    defaultStage = IA02NationStage.Survival;
                    defaultPosture = IA02NationPosture.Development;
                    commercialWeight = Mathf.Max(commercialWeight, 0.72f);
                    break;
                case ModoInicialPaisIA.Crescimento:
                    defaultExecutionMode = IA02ExecutionMode.Hybrid;
                    defaultNationMode = IA02NationMode.Normal;
                    defaultStage = IA02NationStage.Stabilization;
                    defaultPosture = IA02NationPosture.Development;
                    break;
                case ModoInicialPaisIA.Crise:
                    defaultExecutionMode = IA02ExecutionMode.Hybrid;
                    defaultNationMode = IA02NationMode.Peace;
                    defaultStage = IA02NationStage.Recovering;
                    defaultPosture = IA02NationPosture.Recovery;
                    cautionWeight = Mathf.Max(cautionWeight, 0.72f);
                    break;
                case ModoInicialPaisIA.GuerraFria:
                    defaultExecutionMode = IA02ExecutionMode.Hybrid;
                    defaultNationMode = IA02NationMode.Normal;
                    defaultStage = IA02NationStage.Reconnaissance;
                    defaultPosture = IA02NationPosture.Alert;
                    defenseWeight = Mathf.Max(defenseWeight, 0.72f);
                    break;
                case ModoInicialPaisIA.Mobilizacao:
                    defaultExecutionMode = IA02ExecutionMode.Hybrid;
                    defaultNationMode = IA02NationMode.War;
                    defaultStage = IA02NationStage.Emergency;
                    defaultPosture = IA02NationPosture.Preparation;
                    militaryWeight = Mathf.Max(militaryWeight, 0.74f);
                    break;
                case ModoInicialPaisIA.GuerraTotal:
                    defaultExecutionMode = IA02ExecutionMode.Full;
                    defaultNationMode = IA02NationMode.War;
                    defaultStage = IA02NationStage.Emergency;
                    defaultPosture = IA02NationPosture.War;
                ...
                case ModoInicialPaisIA.AgressivoContraJogador:
                    ...
                    defaultNationMode = IA02NationMode.War;
                    defaultStage = IA02NationStage.Emergency;
                    defaultPosture = IA02NationPosture.LimitedAttack;
        ...
        public float ResolveCadence(IA02ExecutionMode executionMode, IA02NationStage stage, IA02NationMode nationMode)
        {
            ...
            if (nationMode == IA02NationMode.War)
            {
                cadence *= 0.70f;
            }
            else if (nationMode == IA02NationMode.Peace)
            {
                cadence *= 1.15f;
            }
        ...
        public float ResolveSliceBudgetMs(IA02ExecutionMode executionMode, IA02NationStage stage, IA02NationMode nationMode)
        {
            ...
            if (stage == IA02NationStage.Initialization || stage == IA02NationStage.Emergency)
            {
                budget *= 0.90f;
            }
            else if (stage == IA02NationStage.GlobalPower)
            {
                budget *= 1.10f;
            }
        ...
        public int ResolveOperationBudget(IA02ExecutionMode executionMode)
        {
        ...
        public int ResolveEventBudget(IA02ExecutionMode executionMode)
        {
            int budget = MaxEventsPerSlice;
            if (executionMode == IA02ExecutionMode.ObserverDebug)
            {
                budget = Mathf.Max(1, Mathf.RoundToInt(budget * 0.75f));
            }
            else if (executionMode == IA02ExecutionMode.Manual)
            {
        ...
        public IA02NationStage ResolveOperationalStage(IA02NationStage currentStage, bool hasCapital, int structureCount, int treasury, int energy, int food, bool threatened, bool atWar, bool emergencyReserve)
        {
            if (!hasCapital)
            {
            ...
            if (threatened || atWar)
            {
                return IA02NationStage.Emergency;
            }

            IA02NationStage targetStage;
            if (structureCount <= 1)
            {
                targetStage = IA02NationStage.Survival;
            }
            else if (structureCount <= 2)
            {
                targetStage = IA02NationStage.Stabilization;
            }
            else if (structureCount <= 3)
            {
                targetStage = IA02NationStage.UrbanDevelopment;
            }
            else if (structureCount <= 4)
            {
                targetStage = IA02NationStage.Industrialization;
            }
            else if (structureCount <= 6)
            {
                targetStage = IA02NationStage.Specialization;
            }
            else if (structureCount <= 8)
            {
                targetStage = IA02NationStage.RegionalProjection;
            }
            else
            {
                targetStage = IA02NationStage.GlobalPower;
            }
            ...
            if (emergencyReserve || treasury < 250 || energy < 250 || food < 250)
            {
                ...
                return structureCount <= 2 ? IA02NationStage.Survival : IA02NationStage.Stabilization;
            }

            return targetStage;
        }

        public IA02NationPosture ResolveOperationalPosture(IA02NationStage stage, bool hasCapital, int structureCount, int treasury, int energy, int food, bool threatened, bool atWar, bool emergencyReserve)
        {
            if (!hasCapital)
            {
                return IA02NationPosture.Development;
            }

            if (threatened)
            {
                return atWar ? IA02NationPosture.War : IA02NationPosture.Defense;
            }
            ...
            if (atWar)
            {
                ...
                return warBias >= defenseBias ? IA02NationPosture.LimitedAttack : IA02NationPosture.Defense;
            }

            if (emergencyReserve || treasury < 250 || energy < 250 || food < 250)
            {
                return IA02NationPosture.Recovery;
            }
            ...
            switch (stage)
            {
                case IA02NationStage.Initialization:
                case IA02NationStage.Reconnaissance:
                    return economic >= defensive ? IA02NationPosture.Development : IA02NationPosture.Peace;
                case IA02NationStage.Survival:
                    return defensive > economic ? IA02NationPosture.Alert : IA02NationPosture.Peace;
                case IA02NationStage.Stabilization:
                    return economic >= defensive ? IA02NationPosture.Peace : IA02NationPosture.Alert;
                case IA02NationStage.UrbanDevelopment:
                    return defensive >= offensive ? IA02NationPosture.Preparation : IA02NationPosture.Alert;
                case IA02NationStage.Industrialization:
                    return offensive > defensive ? IA02NationPosture.Preparation : IA02NationPosture.Alert;
                case IA02NationStage.Specialization:
                    return offensive >= defensive ? IA02NationPosture.LimitedAttack : IA02NationPosture.Preparation;
                case IA02NationStage.RegionalProjection:
                    return offensive >= defensive ? IA02NationPosture.LimitedAttack : IA02NationPosture.Preparation;
                case IA02NationStage.GlobalPower:
                    return offensive >= defensive + 0.25f ? IA02NationPosture.War : IA02NationPosture.LimitedAttack;
                case IA02NationStage.Recovering:
                    return IA02NationPosture.Recovery;
                case IA02NationStage.Emergency:
                    return defensive >= offensive ? IA02NationPosture.Defense : IA02NationPosture.War;
                default:
                    return IA02NationPosture.Development;
            }
        }

        public int ResolveIntentPriority(IA02IntentType intent, IA02NationStage stage, IA02NationPosture posture, int structureCount, bool threatened, bool atWar)
        {
            if (intent == IA02IntentType.EstablishCapital)
            {
                return 1000;
            }
            ...
            if (stage == IA02NationStage.Emergency)
            {
                priority *= 0.85f;
            }
        ...
        public static IA02NationProfile CreateRuntimeFromGovernment(DadosPaisGoverno country, int matchSeed, string difficultyCode = null)
        {
            IA02NationProfile profile = CreateInstance<IA02NationProfile>();
        ...
        private float GetBasePriority(IA02IntentType intent)
        {
            switch (intent)
            {
        ...
        private float GetWeightBonus(IA02IntentType intent)
        {
            switch (intent)
            {
                case IA02IntentType.BuildEnergy:
        ...
        private float GetStageBonus(IA02IntentType intent, IA02NationStage stage)
        {
            switch (stage)
            {
                case IA02NationStage.Initialization:
                case IA02NationStage.Reconnaissance:
                    return intent == IA02IntentType.BuildEnergy ? 120f
                        : intent == IA02IntentType.BuildFoodProduction ? 90f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 50f
                        : intent == IA02IntentType.BuildStorage ? 15f
                        : intent == IA02IntentType.BuildLogistics ? 10f
                        : 0f;
                case IA02NationStage.Survival:
                    return intent == IA02IntentType.BuildEnergy ? 90f
                        : intent == IA02IntentType.BuildFoodProduction ? 110f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 80f
                        : intent == IA02IntentType.BuildStorage ? 25f
                        : intent == IA02IntentType.BuildLogistics ? 15f
                        : 0f;
                case IA02NationStage.Stabilization:
                    return intent == IA02IntentType.BuildEnergy ? 45f
                        : intent == IA02IntentType.BuildFoodProduction ? 55f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 60f
                        : intent == IA02IntentType.BuildStorage ? 85f
                        : intent == IA02IntentType.BuildLogistics ? 75f
                        : intent == IA02IntentType.BuildIndustry ? 40f
                        : intent == IA02IntentType.BuildDefense ? 55f
                        : 0f;
                case IA02NationStage.UrbanDevelopment:
                    return intent == IA02IntentType.BuildEnergy ? 25f
                        : intent == IA02IntentType.BuildFoodProduction ? 25f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 45f
                        : intent == IA02IntentType.BuildStorage ? 95f
                        : intent == IA02IntentType.BuildLogistics ? 105f
                        : intent == IA02IntentType.BuildIndustry ? 40f
                        : intent == IA02IntentType.BuildDefense ? 70f
                        : 0f;
                case IA02NationStage.Industrialization:
                    return intent == IA02IntentType.BuildEnergy ? 20f
                        : intent == IA02IntentType.BuildFoodProduction ? 10f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 20f
                        : intent == IA02IntentType.BuildStorage ? 115f
                        : intent == IA02IntentType.BuildLogistics ? 110f
                        : intent == IA02IntentType.BuildIndustry ? 190f
                        : intent == IA02IntentType.BuildDefense ? 100f
                        : 0f;
                case IA02NationStage.Specialization:
                    return intent == IA02IntentType.BuildEnergy ? 10f
                        : intent == IA02IntentType.BuildFoodProduction ? 5f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 10f
                        : intent == IA02IntentType.BuildStorage ? 125f
                        : intent == IA02IntentType.BuildLogistics ? 125f
                        : intent == IA02IntentType.BuildIndustry ? 160f
                        : intent == IA02IntentType.BuildDefense ? 155f
                        : 0f;
                case IA02NationStage.RegionalProjection:
                    return intent == IA02IntentType.BuildEnergy ? 5f
                        : intent == IA02IntentType.BuildFoodProduction ? 5f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 5f
                        : intent == IA02IntentType.BuildStorage ? 120f
                        : intent == IA02IntentType.BuildLogistics ? 135f
                        : intent == IA02IntentType.BuildIndustry ? 130f
                        : intent == IA02IntentType.BuildDefense ? 170f
                        : 0f;
                case IA02NationStage.GlobalPower:
                    return intent == IA02IntentType.BuildEnergy ? 5f
                        : intent == IA02IntentType.BuildFoodProduction ? 5f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 5f
                        : intent == IA02IntentType.BuildStorage ? 110f
                        : intent == IA02IntentType.BuildLogistics ? 140f
                        : intent == IA02IntentType.BuildIndustry ? 120f
                        : intent == IA02IntentType.BuildDefense ? 180f
                        : 0f;
                case IA02NationStage.Recovering:
                    return intent == IA02IntentType.BuildEnergy ? 120f
                        : intent == IA02IntentType.BuildFoodProduction ? 120f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 100f
                        : intent == IA02IntentType.BuildStorage ? 45f
                        : intent == IA02IntentType.BuildLogistics ? 30f
                        : 0f;
                case IA02NationStage.Emergency:
                    return intent == IA02IntentType.BuildEnergy ? 20f
                        : intent == IA02IntentType.BuildFoodProduction ? 20f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 20f
                        : intent == IA02IntentType.BuildStorage ? 10f
                        : intent == IA02IntentType.BuildLogistics ? 5f
                        : intent == IA02IntentType.BuildIndustry ? 20f
                        : intent == IA02IntentType.BuildDefense ? 100f
                        : 0f;
                default:
                    return 0f;
        ...
        private float GetPostureBonus(IA02IntentType intent, IA02NationPosture posture)
        {
            switch (posture)
            {
                case IA02NationPosture.Development:
                    return intent == IA02IntentType.BuildEnergy ? 20f
                        : intent == IA02IntentType.BuildFoodProduction ? 20f
                        : intent == IA02IntentType.BuildResidentialCapacity ? 15f
                        : 0f;
                case IA02NationPosture.Peace:
                    return intent == IA02IntentType.BuildResidentialCapacity ? 20f
                        : intent == IA02IntentType.BuildStorage ? 10f
                        : intent == IA02IntentType.BuildIndustry ? 35f
                        : 0f;
                case IA02NationPosture.Alert:
                    return intent == IA02IntentType.BuildStorage ? 20f
                        : intent == IA02IntentType.BuildLogistics ? 25f
                        : intent == IA02IntentType.BuildIndustry ? 60f
                        : intent == IA02IntentType.BuildDefense ? 90f
                        : 0f;
                case IA02NationPosture.Preparation:
                    return intent == IA02IntentType.BuildStorage ? 25f
                        : intent == IA02IntentType.BuildLogistics ? 30f
                        : intent == IA02IntentType.BuildEnergy ? 10f
                        : intent == IA02IntentType.BuildIndustry ? 75f
                        : intent == IA02IntentType.BuildDefense ? 110f
                        : 0f;
                ...
                case IA02NationPosture.LimitedAttack:
                    return intent == IA02IntentType.BuildLogistics ? 30f
                        : intent == IA02IntentType.BuildStorage ? 20f
                        : intent == IA02IntentType.BuildIndustry ? 50f
                        : intent == IA02IntentType.BuildDefense ? 70f
                        : 0f;
                case IA02NationPosture.War:
                    return intent == IA02IntentType.BuildLogistics ? 35f
                        : intent == IA02IntentType.BuildStorage ? 25f
                        : intent == IA02IntentType.BuildIndustry ? 50f
                        : intent == IA02IntentType.BuildDefense ? 100f
                        : 0f;
        ...
        private float GetStructureBonus(IA02IntentType intent, int structureCount)
        {
            if (structureCount <= 1)
            {
                return intent == IA02IntentType.BuildEnergy ? 70f
                    : intent == IA02IntentType.BuildFoodProduction ? 30f
                    : intent == IA02IntentType.BuildResidentialCapacity ? 15f
                    : intent == IA02IntentType.BuildStorage ? 5f
                    : 0f;
            }

            if (structureCount == 2)
            {
                return intent == IA02IntentType.BuildFoodProduction ? 70f
                    : intent == IA02IntentType.BuildResidentialCapacity ? 30f
                    : intent == IA02IntentType.BuildStorage ? 15f
                    : intent == IA02IntentType.BuildLogistics ? 5f
                    : intent == IA02IntentType.BuildEnergy ? 20f
                    : 0f;
            }

            if (structureCount == 3)
            {
                return intent == IA02IntentType.BuildResidentialCapacity ? 70f
                    : intent == IA02IntentType.BuildStorage ? 30f
                    : intent == IA02IntentType.BuildLogistics ? 15f
                    : intent == IA02IntentType.BuildEnergy ? 15f
                    : intent == IA02IntentType.BuildFoodProduction ? 10f
                    : 0f;
            }
            ...
            if (structureCount == 4)
            {
                return intent == IA02IntentType.BuildIndustry ? 20f
                    : intent == IA02IntentType.BuildStorage ? 70f
                    : intent == IA02IntentType.BuildLogistics ? 55f
                    : intent == IA02IntentType.BuildEnergy ? 15f
                    : intent == IA02IntentType.BuildFoodProduction ? 10f
                    : intent == IA02IntentType.BuildResidentialCapacity ? 20f
                    : 0f;
            ...
            if (structureCount == 5)
            {
                return intent == IA02IntentType.BuildIndustry ? 35f
                    : intent == IA02IntentType.BuildLogistics ? 80f
                    : intent == IA02IntentType.BuildStorage ? 40f
                    : intent == IA02IntentType.BuildEnergy ? 10f
                    : intent == IA02IntentType.BuildFoodProduction ? 10f
                    : intent == IA02IntentType.BuildResidentialCapacity ? 15f
                    : 0f;
            ...
            if (structureCount <= 8)
            {
                return intent == IA02IntentType.BuildDefense ? 80f
                    : intent == IA02IntentType.BuildIndustry ? 50f
                    : intent == IA02IntentType.BuildLogistics ? 60f
                    : intent == IA02IntentType.BuildStorage ? 35f
                    : 0f;
            }

            return intent == IA02IntentType.BuildDefense ? 100f
                : intent == IA02IntentType.BuildIndustry ? 70f
                : intent == IA02IntentType.BuildLogistics ? 80f
                : 0f;
        }
    }
