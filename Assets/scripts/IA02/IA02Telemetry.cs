...
{
    public sealed class IA02Telemetry
    {
        ...
        public void SetServiceReport(string report)
        {
            ...
            try
            {
                global::DiagnosticoDesempenhoJogo.RegistrarTextoMetrica("ia02.services", serviceReport);
            }
            catch
            {
        ...
        public void RecordSlice(IA02Controller controller, IA02WorkResult result, int registryEntries, int dirtyCount)
        {
            if (controller == null)
            {
                return;
            ...
            try
            {
                global::DiagnosticoDesempenhoJogo.RegistrarMetricaTempo("ia02.slice." + controller.NationId, result.ConsumedMilliseconds);
                global::DiagnosticoDesempenhoJogo.IncrementarContadorMetrica("ia02.slice.count");
            }
            catch
            {
                // Optional logger.
        ...
        public void RecordFrame(float frameMs)
        {
            ...
            // RecordSlice (ia02.slice.<pais>); publicar o frame inteiro como
            // "ia02.frame" fazia o diagnostico apontar falsamente a IA como causa.
            ...
            try
            {
                global::DiagnosticoDesempenhoJogo.IncrementarContadorMetrica("ia02.frame.count");
            }
            catch
            {
                // Optional logger.
        ...
        public IA02TelemetrySnapshot CaptureSnapshot(float now)
        {
            IA02TelemetrySnapshot snapshot = new IA02TelemetrySnapshot
            {
                CaptureTime = now,
            ...
            for (int i = 0; i < ordered.Count; i++)
            {
                ...
                snapshot.Nations.Add(new IA02NationTelemetrySnapshot
                {
        ...
        {
            IA02TelemetrySnapshot snapshot = CaptureSnapshot(now);
