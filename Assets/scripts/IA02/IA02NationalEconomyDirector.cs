...
namespace Hegemonia.AI.IA02
{
    ...
    public sealed class IA02NationalEconomyDirector
    {
        ...
        public IA02NationalEconomyDirector(IA02RuntimeContext context)
        {
            this.context = context;
        }

        public bool Plan(float now, IA02IntentBoard board, bool emergencyReserve, bool constructionPending, bool threatened)
        {
            ...
            {
                if (intent != null && intent.Type == IA02IntentType.EstablishCapital)
                {
                    nextActionAt = now + 4f;
            ...
            {
                board.Publish(IA02IntentType.BuyResource, threatened ? 930 : 760, "Comprar " + need, now);
            ...
            {
                board.Publish(IA02IntentType.SellResource, 360, "Vender excedente de " + surplus, now);
        ...
        private bool TryBuy(SistemaGovernoMundial government, SistemaMercadoGlobal market, DadosPaisGoverno buyer, RecursoMercado resource)
        {
            ...
            if (seller.teamId == government.teamJogador)
            {
                bool created = government.TentarCriarProposta(new PropostaInternacional
                {
                    ...
                    dedupKey = "ia02:buy:" + buyer.teamId + ":" + seller.teamId + ":" + resource
                });
        ...
        private bool TrySell(SistemaGovernoMundial government, SistemaMercadoGlobal market, DadosPaisGoverno seller, RecursoMercado resource)
        {
            ...
            if (buyer.teamId == government.teamJogador)
            {
                bool created = government.TentarCriarProposta(new PropostaInternacional
                {
                    ...
                    dedupKey = "ia02:sell:" + seller.teamId + ":" + buyer.teamId + ":" + resource
                });
