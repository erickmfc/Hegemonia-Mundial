...
namespace Hegemonia.AI.IA02
{
        ...
        public void PublishNeeds(IA02IntentBoard board, float now, IA02NationProfile profile, DadosPaisGoverno country, bool emergencyReserve)
        {
            ...
            if (controller != null && controller.UseScriptedOpening)
            {
                ...
                for (int i = 0; i < FoundationSequence.Length; i++)
                {
                    ...
                    if (step == IA02IntentType.BuildMilitaryTent
                        && controller != null
    ...
    public sealed class IA02BuildCatalogAdapter
    {
        ...
        private static int ResolveInfrastructurePriority(IA02IntentType intent, IA02BuildDefinition candidate, DadosPaisGoverno country)
        {
        ...
        private static bool IsEgyptCityResidentialIntent(IA02IntentType intent)
        {
    ...
    public sealed class IA02BuildDirector
    {
        ...
        public bool Plan(float now, IA02IntentBoard board)
        {
            ...
            try
            {
                ...
                if (IA02_CityIntentAdapter.IsCityIntent(intent.Type))
                {
                    ...
                    && IA_CityExpansionPolicy.IsCityConstruction(definition.Item))
                {
                        ...
                        out cityAssessment))
                    {
                        ...
                        context.SetMetric("ia02.city_preparation_blocked", 1d);
                        return false;
                    }
                    context.SetMetric("ia02.city_preparation_blocked", 0d);
                }
    ...
    public sealed class IA02WarDirector
    {
        ...
        public void RegisterHostileAggression(int attackerTeamId, Vector3 attackerPosition, float damage)
        {
            ...
            if (!hostileContacts.TryGetValue(attackerTeamId, out contact) || contact == null)
            {
                ...
                Debug.Log("[IA02 Combat] Time " + context.TeamId + " detectou o contato " + attackerTeamId + "; iniciando observacao.");
            }
            ...
            if (contact.DetectionCount >= 2 || contact.Damage >= 35f) contact.Confirmed = true;
            Status = contact.Confirmed
                ? "Agressor confirmado: time " + attackerTeamId + "; preparando resposta."
                : "Contato detectado: time " + attackerTeamId + "; patrulha investigando.";
        }
        ...
        private bool QueueRetaliation(float now, IA02IntentBoard board, bool emergencyReserve)
        {
            ...
            {
                Status = "Contato suspeito mantido em observacao; sem retaliacao automatica.";
                return false;
            }
