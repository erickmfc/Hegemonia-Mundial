...
{
    // Read-only adapter: the simulation remains the source of truth and IA02 only mirrors observations.
    public sealed class IA02GameStateBridge
    {
        private int industrialResourceCursor;

        public int LastChangedResources { get; private set; }

        public int Refresh(IA02RuntimeContext context, int maxIndustrialResources)
        {
        ...
        private int RefreshIndustrialResources(IA02RuntimeContext context, int maxResources)
        {
        ...
        private static void RefreshMarketMetrics(IA02RuntimeContext context)
        {
        ...
        private static void RefreshTimeMetrics(IA02RuntimeContext context)
        {
