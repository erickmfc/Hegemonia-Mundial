...
namespace Hegemonia.AI.IA02
{
    ...
    public sealed class IA02AirPatrolZone : MonoBehaviour
    {
        ...
        public Vector3[] CriarRota(int indice)
        {
            ...
            // A variação deve apenas distribuir aeronaves dentro do setor.
            // O limite anterior de 1.28 fazia algumas rotas ultrapassarem a
            // largura/profundidade configuradas do próprio Create.
            float escala = Mathf.Clamp(1f + variacao, 0.62f, 1f);
