...
namespace Hegemonia.AI.IA02
{
    ...
    public enum IA02BuildArchetype
    {
    ...
    public enum IA02ConstructionMode
    {
        Active = 0,
        Frozen = 1
    }

    public enum IA02ConstructionState
    {
        Idle = 0,
        SelectingIntent = 1,
    ...
    public enum IA02BuildSlotState
    {
    ...
    public enum IA02BuildConditionType
    {
    ...
    public sealed class IA02Intent
    {
        public string Id;
        public IA02IntentType Type;
        public int Priority;
    ...
    public sealed class IA02BuildDefinition
    {
        public DadosConstrucao Item;
        public string ItemId;
        public string DisplayName;
        public IA02BuildArchetype Archetype;
        public IA02StrategicRole StrategicRole { get; set; }
        public IA02BuildDomain Domain { get; set; }
        ...
        public IA02NationStage MinimumStage;
        public bool UsedCatalogFallback;
        public string CatalogResolution;
    }

    public sealed class IA02BuildLot
    {
        public Vector3 Position;
        public Quaternion Rotation;
        public Vector2 Footprint;
        public string Key;
        public IA02LotState State;
    }

    public sealed class IA02Campaign
    {
